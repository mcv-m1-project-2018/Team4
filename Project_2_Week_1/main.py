...
if __name__ == "__main__":
    if len(sys.argv) > 1:
        ...
        museum_set, museum_histograms_by_type = read_set(museum_path, block_color_space, block_factor)
        query_set, query_histograms_by_type = read_set(query_path, block_color_space, block_factor)
