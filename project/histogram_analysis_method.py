    ...
    if (is_grouped):
        for class_id in range(0, len(dataset)):
            ...
            try:
                ...
                if not zoom:
                    plt.xlim([0,255])
                    plt.ylim([0,255])
                    plt.savefig('color' + str(class_id)+'.png',bbox_inches='tight')
                else:
                    plt.savefig('color' + str(class_id)+'-zoom.png',bbox_inches='tight')
                # uncomment to see the plot after each class loop
                #plt.show()
            except:
        ...
        try:
            ...
            if not zoom:
                plt.xlim([0,255])
                plt.ylim([0,255])
                plt.savefig('whole-dataset.png',bbox_inches='tight')
            else:
                plt.savefig('whole-dataset-original.png',bbox_inches='tight')
            # uncomment to see the plot after each class loop
            #plt.show()
        except:
            print("sorry, wont happen")
